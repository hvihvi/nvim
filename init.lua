...
--    lazy.nvim imports every spec it finds there, so adding a plugin
--    is just dropping a new file in that directory.
require('lazy').setup({
  { import = 'plugins' },
}, {
  ui = {
    -- Use a fancy border if a Nerd Font is available, plain icons otherwise.
